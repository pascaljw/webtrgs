        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
          <div class="row align-items-xl-center gy-5">
            ...
            <div class="col-xl-12 content">
              <h3>Tentang Kami</h3>
              <h2 style="font-size: 1.5rem">Program Studi Teknologi Rekayasa Geomatika dan Survei (DIV – Sarjana Terapan)</h2>
              <p>Program Studi Teknologi Rekayasa Geomatika dan Survei merupakan program studi Sarjana Terapan di bidang Geospasial. Program Studi Teknologi Rekayasa Geomatika dan Survei berdiri berdasarkan Keputusan Menteri Pendidikan, Kebudayaan, Riset, dan Teknologi Republik Indonesia Nomor 119/D/OT/2023 tanggal 31 Mei 2023.

                Program Studi Teknologi Rekayasa Geomatika dan Survei memulai menerima mahasiswa baru dan  menyelenggarakan perkuliahan perdana pada semester ganjil 2023/2024. Program Studi Teknologi Rekayasa Geomatika dan Survei terakreditasi Baik berdasarkan Keputusan Badan Akreditasi Nasional Perguruan Tinggi No. 2743/SK/BAN-PT/Ak.P/STr/VII/2023 Tanggal 11 Juli 2023.</p>
            ...
            <div class="col-lg-6 " data-aos="fade-up" data-aos-delay="100">
              <div class="service-item d-flex">
                ...
                @php
                          ...
                          $title = substr($item->story, $titleStart + 3, $titleEnd - $titleStart - 3); // Extract the title

                          // Trim any leading/trailing spaces
                          $title = trim($title);

                          $closingTagPosition = strpos($item->story, '</p>');
 
                          // Extract the content after the closing tag '</p>'
                          $contentAfterP = substr($item->story, $closingTagPosition + 4);
                      @endphp
                      <div>
