        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form method="post" action="{{ route('acreditation.store') }}">
                        @csrf
                        <div class="row">
                            <div class="mb-3 col-12">
                                <textarea name="acreditation" class="form-control summernote" rows="6"></textarea>
                            </div>
                        </div>
                </div>
                <div class="card-footer">
                    <a href="{{ route('acreditation') }}" class="btn btn-info">Close</a>
