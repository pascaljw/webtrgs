...
<div class="row page-titles">
    <ol class="breadcrumb">
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Beasiswa</a></li>
        ...
        <div class="card">
            <div class="card-body">
                <div class="basic-form">
                    <form method="post" action="{{ route('scholarship.update', $scholarship->id) }}">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="mb-3 col-12">
                                <label class="form-label">Beasiswa</label>
                                <textarea name="scholarship" class="form-control summernote" rows="10">
