                    ...
                    <form method="post" action="{{ route('document.update', $document->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <textarea name="description" class="form-control summernote" rows="4">{{ $document->description }}</textarea>
                            </div>
                            <div class="mb-3 col-12">
                                <label class="form-label">Pilih File <i>hanya untuk menggati dokumen</i></label>
