    ...
    <div class="col-xl-12 col-xxl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Riset dan Pengabdian</h4>
            </div>
            <div class="card-body">
                    ...
                    <form method="post" action="{{ route('research.store') }}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-12">
                                <textarea name="research" class="form-control summernote" rows="6"></textarea>
                            </div>
                        </div>
                </div>
                <div class="card-footer">
                    <a href="{{ route('research') }}" class="btn btn-info">Close</a>
