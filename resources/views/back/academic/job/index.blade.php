...
<div class="row page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">Lulusan</a></li>
    </ol>
</div>
    ...
    <div class="col-xl-12 col-xxl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Profil Lulusan (editable)</h4>
            </div>
            <div class="card-body">
                    ...
                    <form method="post" action="{{ route('job.update', $job->id) }}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-12">
                                <label class="form-label">Profil Lulusan</label>
                                <textarea name="job" class="form-control summernote" rows="10">
                                    {{ $job->job }}
                                </textarea>
                            </div>
                        </div>
