    ...
    <div class="col-xl-12 col-xxl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Layanan Politani (editable)</h4>
            </div>
            <div class="card-body">
                    ...
                    <form method="post" action="{{ route('service.update', $service->id) }}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-12">
                                <label class="form-label">Layanan Politani</label>
                                <textarea name="service" class="form-control summernote" rows="10">
                                    {{ $service->service }}
                                </textarea>
                            </div>
                        </div>
