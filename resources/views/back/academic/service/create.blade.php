...
<div class="row page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">Politani</a></li>
    </ol>
</div>
    ...
    <div class="col-xl-12 col-xxl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Layanan Politani</h4>
            </div>
            <div class="card-body">
                    ...
                    <form method="post" action="{{ route('service.store') }}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-12">
                                <textarea name="service" class="form-control summernote" rows="6"></textarea>
                            </div>
                        </div>
                </div>
                <div class="card-footer">
                    <a href="{{ route('service') }}" class="btn btn-info">Close</a>
