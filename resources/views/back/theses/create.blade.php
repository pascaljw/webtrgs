                ...
                <div class="row">
                    <div class="col-xl-6  col-md-6 mb-4">
                      <label  class="form-label font-w600">Nama Mahasiswa<span class="text-danger scale5 ms-2">*</span></label>
                        <input name="name" type="text" class="form-control solid" placeholder="Nama" aria-label="name">
                    </div>
                    <div class="col-xl-6  col-md-6 mb-4">
                      <label  class="form-label font-w600">NIM<span class="text-danger scale5 ms-2">*</span></label>
                        <input name="nim" type="text" class="form-control solid" placeholder="Nomor Induk Mahasiswa" aria-label="name">
                    </div>
                    <div class="col-xl-12  col-md-12 mb-4">
                        <label  class="form-label font-w600">Judul Skripsi<span class="text-danger scale5 ms-2">*</span></label>
                        <textarea name="title" class="form-control solid" aria-label="With textarea"></textarea>
                    </div>
                    <div class="col-xl-6  col-md-6 mb-4">
                        <label  class="form-label font-w600">Pembimbing 1<span class="text-danger scale5 ms-2">*</span></label>
                        <input name="adviser1" type="text" class="form-control solid" placeholder="Nama Pembimbing 1" aria-label="name">
                    </div>
                    <div class="col-xl-6  col-md-6 mb-4">
                        <label  class="form-label font-w600">Pembimbing 2<span class="text-danger scale5 ms-2">*</span></label>
                        <input name="adviser2" type="text" class="form-control solid" placeholder="Nama Pembimbing 2" aria-label="name">
                    </div>
                    <div class="col-xl-6  col-md-6 mb-4">
                        <label  class="form-label font-w600">Penguji 1<span class="text-danger scale5 ms-2">*</span></label>
                        <input name="adviser3" type="text" class="form-control solid" placeholder="Nama Penguji 1" aria-label="name">
                    </div>
                    <div class="col-xl-6  col-md-6 mb-4">
                        <label  class="form-label font-w600">Penguji 2<span class="text-danger scale5 ms-2">*</span></label>
                        <input name="adviser4" type="text" class="form-control solid" placeholder="Nama Penguji 2" aria-label="name">
                    </div>
                    <div class="col-xl-6  col-md-6 mb-4">
                        <label  class="form-label font-w600">Tahun<span class="text-danger scale5 ms-2">*</span></label>
                        <input name="year" type="number" class="form-control solid" placeholder="2024" aria-label="name">
