                    ...
                    <form method="post" action="{{ route('admin.tentang.store') }}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-12">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" placeholder="Title Of Content">
                                @error('title')
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <textarea name="body" class="form-control summernote @error('body') is-invalid @enderror" rows="4">{{ old('content') }}</textarea>
                                @error('body')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
