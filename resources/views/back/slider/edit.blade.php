...
<div class="row page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">Slider Frontend</a></li>
    </ol>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form method="post" action="{{ route('slider.update', $slider->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @error('title') is-invalid @enderror" value="{{ old('title') ?? $slider->title }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label>Slider Content Minimalist</label>
                                <input type="text" name="content" class="form-control
                                @error('content') is-invalid @enderror" value="{{ old('content') ?? $slider->content }}">
                ...
                <div class="card-footer">
                    <a href="{{ route('slider') }}" class="btn btn-info">Close</a>
